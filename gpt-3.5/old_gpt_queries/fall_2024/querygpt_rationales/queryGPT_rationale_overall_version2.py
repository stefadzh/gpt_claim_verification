...
gt_path = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\sentence_level_ground_truth-v1_domain_version2.csv'
export_path = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\rationale\\zero_shot'
...
def start_up():
    inFile = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\sentence_level_ground_truth-v1_domain.csv'
    inFile_unindexed = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\claim_level_ground_truth-v1_for_rationale.csv'
    inDir_domain = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain\\'    
    outDir_domain = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain_rationale\\'
...
def prompt_generation():
    file_path = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain_rationale\\domain\\'
    num_runs = 1
    
    def zero_shot():
        export_path = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\rationale\\zero_shot\\'
        df_gt = pd.read_csv('C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain_rationale\\indexed_rationale_gt.csv')
        for file in os.listdir(file_path):
            if file.endswith(".csv") and (file in ['health_domain.csv','humans_domain.csv']):
                domain = file
                print("path + domain is: ", file_path + domain)
                df = pd.read_csv(file_path+domain) 
                df_training = df.head(4)
                df_testing = df.tail(len(df) - 4)
                prompts = []
                print("here are the columns in df_gt:", df_gt.columns)
                ...
                for index, test_sample in df_testing.iterrows():
                    ...
                    abstract = df_gt[df_gt['id'] == test_sample['id']]['prompts'].values[0]  #changed prompts to Prompt
                ...
                rationale_df = pd.read_csv('C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain_rationale\\indexed_rationale_gt.csv', usecols=['id', 'support', 'true/false','domain'])
