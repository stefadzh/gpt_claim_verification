...
file_path2 = 'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\claim_level_ground_truth-v1.csv'
# export_path = f'gpt-3.5/data2/{num_shots}-CoT/'
export_path = f'C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\{num_shots}-CoT-gpt4\\'
...
def prompt_generation():
    ...
    for file in os.listdir(file_path):
        if file.endswith(".csv") and file != "out_domain.csv":
            ...
            directory = os.path.dirname(export_path + domain2)
