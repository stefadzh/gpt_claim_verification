...
def prompt_generation(num_shots):
    ...
    testing_data_frames = []
    df_out_domain_testing = pd.read_csv('C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\ground_truth_datasets\\domain\\out_domain.csv')
    ...
    df_training.to_csv('C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\overall\out_training.csv', index=False)
    df_testing.to_csv('C:\\Users\\dzham\\Desktop\\ODUWuProject\\GPTredo\\msvec_v2\\gpt-3.5\\data2\\overall\out_testing.csv', index=False)
